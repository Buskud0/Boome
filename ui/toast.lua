...
local SLOT_SIZE = TOAST_SLOT_SIZE
local INVENTORY_OFFSET_Y = TOAST_INVENTORY_OFFSET_Y
local FADE_DURATION = TOAST_FADE_DURATION
local TOAST_BASE_Y = SLOT_SIZE + INVENTORY_OFFSET_Y
local MAX_TOASTS = TOAST_MAX_TOASTS
